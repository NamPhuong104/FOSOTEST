...
export function Header() {
  ...
  const handleLogout = () => {
    // Sử dụng hàm removeToken từ lib/auth để xóa token từ cả localStorage và cookie
    removeToken()
  ...
  return (
    <footer className='border-t py-6'>
      <div className='container flex flex-col items-center justify-between gap-4 md:flex-row'>
        <p className='text-center text-sm text-muted-foreground'>&copy; Next.js 15 Starter. All rights reserved.</p>
        <nav className='flex items-center gap-4'>
          <Link href='https://nextjs.org' target='_blank' className='text-sm text-muted-foreground hover:underline'>
            Next.js
          </Link>
          <Link
